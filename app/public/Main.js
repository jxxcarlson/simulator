...
var $author$project$ModelTypes$Item = function (a) {
	return {$: 'Item', a: a};
};
var $author$project$Internal$Types$BankTime = function (a) {
	return {$: 'BankTime', a: a};
};
var $author$project$Internal$Money$bankTime = function (t) {
	return $author$project$Internal$Types$BankTime(t);
};
var $author$project$Money$bankTime = $author$project$Internal$Money$bankTime;
var $author$project$Internal$Types$Complementary = {$: 'Complementary'};
var $author$project$Internal$Types$Currency = F2(
	function (a, b) {
		return {$: 'Currency', a: a, b: b};
	});
var $author$project$Internal$Money$createCompCurrency = function (name) {
	return A2($author$project$Internal$Types$Currency, $author$project$Internal$Types$Complementary, name);
};
var $author$project$Money$createCompCurrency = $author$project$Internal$Money$createCompCurrency;
var $author$project$EngineData$cambiatus = $author$project$Money$createCompCurrency('Cambiatus');
var $author$project$Internal$Types$Cents = function (a) {
	return {$: 'Cents', a: a};
};
var $author$project$Internal$Types$Infinite = {$: 'Infinite'};
var $author$project$Internal$Types$Money = function (a) {
	return {$: 'Money', a: a};
};
var $elm$core$Basics$round = _Basics_round;
var $author$project$Internal$Money$createInfinite = F3(
	function (currency_, issuedAt_, amount_) {
		return $author$project$Internal$Types$Money(
			{
				amount: $author$project$Internal$Types$Cents(
					$elm$core$Basics$round(100.0 * amount_)),
				currency: currency_,
				expiresAt: $author$project$Internal$Types$Infinite,
				issuedAt: $author$project$Internal$Types$BankTime(issuedAt_)
			});
	});
var $author$project$Money$createInfinite = $author$project$Internal$Money$createInfinite;
var $author$project$Internal$Types$Value = F2(
	function (a, b) {
		return {$: 'Value', a: a, b: b};
	});
var $author$project$Internal$Value$create = F2(
	function (currency_, amount_) {
		return A2(
			$author$project$Internal$Types$Value,
			currency_,
			$author$project$Internal$Types$Cents(
				$elm$core$Basics$round(amount_ / 100.0)));
	});
var $author$project$Money$createValue = $author$project$Internal$Value$create;
var $author$project$Internal$Types$Fiat = {$: 'Fiat'};
var $author$project$Internal$Money$createFiatCurrency = function (name) {
	return A2($author$project$Internal$Types$Currency, $author$project$Internal$Types$Fiat, name);
};
...
var $author$project$EngineData$config1 = {
	...
	gridWidth: 30,
	householdConsumptionDays: _List_fromArray(
		[3, 7, 12, 15, 19, 23, 26, 29]),
	householdInventoryUpperLimit: 6,
	householdMaximumPurchaseAmount: 12,
	householdMinimumPurchaseAmount: 2,
	householdPayDays: _List_fromArray(
		[1, 15]),
	householdPurchaseDays: _List_fromArray(
		[1, 5, 9, 13, 17, 21, 25, 28]),
	itemA: $author$project$ModelTypes$Item(
		{
			name: 'AA',
			price: A2($author$project$Money$createValue, $author$project$EngineData$fiatCurrency, 2.0),
			quantity: 1
		}),
	itemAMoney: A3($author$project$Money$createInfinite, $author$project$EngineData$fiatCurrency, 0, 2.0),
	itemCost: 1.0,
...
var $author$project$Entity$BusinessCharacteristics = function (a) {
	return {$: 'BusinessCharacteristics', a: a};
};
var $author$project$Entity$Entity = F2(
	function (a, b) {
...
var $author$project$Entity$TShop = {$: 'TShop'};
...
var $author$project$ModelTypes$setQuantity = F2(
	function (q, _v0) {
		var data = _v0.a;
		return $author$project$ModelTypes$Item(
			_Utils_update(
				data,
				{quantity: q}));
	});
var $author$project$EngineData$business1 = function (config) {
	return A2(
		$author$project$Entity$Entity,
		{
			...
			name: 'A',
			position: A2($jxxcarlson$elm_cell_grid$CellGrid$Position, 8, config.gridWidth - 5)
		},
		$author$project$Entity$BusinessCharacteristics(
			{radius: config.businessRadius, unitsPurchased: 0}));
};
var $author$project$Entity$setName = F2(
	function (name, _v0) {
		var common = _v0.a;
		var characteristics = _v0.b;
		return A2(
			$author$project$Entity$Entity,
			_Utils_update(
				common,
...
var $author$project$Entity$setPosition = F3(
	function (i, j, _v0) {
		var common = _v0.a;
		var characteristics = _v0.b;
		return A2(
			...
			_Utils_update(
				common,
				{
					position: A2($jxxcarlson$elm_cell_grid$CellGrid$Position, i, j)
				}),
			characteristics);
	});
var $author$project$EngineData$business2 = function (config) {
	return A3(
		$author$project$Entity$setPosition,
		config.gridWidth - 5,
		5,
		A2(
			$author$project$Entity$setName,
			'B',
			$author$project$EngineData$business1(config)));
};
var $author$project$EngineData$businesses = function (config) {
	return _List_fromArray(
		[
			$author$project$EngineData$business1(config),
			$author$project$EngineData$business2(config)
		]);
};
var $author$project$State$configureWithBusinesses = F2(
	function (config, state) {
		return _Utils_update(
			state,
			{
				businesses: $author$project$EngineData$businesses(config)
			});
	});
var $author$project$Entity$EducatorCharacteristics = function (a) {
...
var $author$project$EngineData$educator1 = function (config) {
	return A2(
		$author$project$Entity$Entity,
		{
			color: A4($avh4$elm_color$Color$rgba, 0.2, 0.8, 0.2, 0.8),
			complementaryAccount: $author$project$Account$empty($author$project$EngineData$cambiatus),
			entityType: $author$project$Entity$TEducator,
			fiatAccount: $author$project$Account$empty($author$project$EngineData$fiatCurrency),
			inventory: _List_Nil,
			name: 'E',
			position: A2($jxxcarlson$elm_cell_grid$CellGrid$Position, config.gridWidth - 1, config.gridWidth - 1)
		},
		$author$project$Entity$EducatorCharacteristics(
			{}));
};
var $author$project$EngineData$educators = function (config) {
	return _List_fromArray(
		[
			$author$project$EngineData$educator1(config)
		]);
};
var $author$project$State$configureWithEducators = F2(
	function (config, state) {
		return _Utils_update(
			state,
			{
				educators: $author$project$EngineData$educators(config)
			});
	});
...
var $author$project$State$configureWithGivenSeed = F3(
	function (config, k, state) {
		var newSeed = $elm$random$Random$initialSeed(k);
		return _Utils_update(
			state,
			{seed: newSeed});
	});
var $author$project$Entity$getPosition = function (_v0) {
	var common = _v0.a;
	var characteristics = _v0.b;
	return common.position;
};
var $author$project$Entity$HouseholdCharacteristics = function (a) {
	return {$: 'HouseholdCharacteristics', a: a};
};
var $author$project$Entity$THousehold = {$: 'THousehold'};
...
var $author$project$Internal$Money$amount = function (_v0) {
	var m = _v0.a;
	return m.amount;
};
...
var $author$project$Internal$Money$valueInCents_ = function (list) {
	if (!list.b) {
		return $author$project$Internal$Types$Cents(0);
	} else {
		return function (s) {
			return $author$project$Internal$Types$Cents(s);
		}(
			$elm$core$List$sum(
				A2(
					$elm$core$List$map,
					...
					A2($elm$core$List$map, $author$project$Internal$Money$amount, list))));
	}
};
var $author$project$Internal$Money$consolidate = function (list) {
	...
	if (_v0.$ === 'Nothing') {
		...
		var m = _v0.a.a;
		return $elm$core$Maybe$Just(
			$author$project$Internal$Types$Money(
				_Utils_update(
					m,
					{
						amount: $author$project$Internal$Money$valueInCents_(list)
					})));
	}
};
...
var $author$project$Internal$Money$isValid = F2(
	function (_v0, _v1) {
		var currentTime = _v0.a;
		var m = _v1.a;
		var _v2 = m.issuedAt;
		var issueTime = _v2.a;
		if (_Utils_cmp(issueTime, currentTime) > 0) {
			return false;
		} else {
			var _v3 = m.expiresAt;
			if (_v3.$ === 'Infinite') {
				...
				var expirationTime = _v3.a.a;
				return _Utils_cmp(expirationTime, currentTime) > -1;
			}
		}
	});
var $author$project$Internal$Account$ensureValid = F2(
	function (bankTime_, _v0) {
		var acct = _v0.a;
		return $author$project$Internal$Account$Account(
			{
				...
				transactions: A2(
					...
					$author$project$Internal$Money$isValid(bankTime_),
					acct.transactions)
			});
	});
...
var $author$project$Internal$Money$expiresAt = function (_v0) {
	var m = _v0.a;
	return m.expiresAt;
};
var $author$project$Internal$Money$issuedAt = function (_v0) {
	var m = _v0.a;
	return m.issuedAt;
};
var $author$project$Internal$Money$samePeriod = F2(
	function (a, b) {
		return _Utils_eq(
			$author$project$Internal$Money$issuedAt(a),
			$author$project$Internal$Money$issuedAt(b)) && _Utils_eq(
			$author$project$Internal$Money$expiresAt(a),
			$author$project$Internal$Money$expiresAt(b));
	});
var $elm$core$Tuple$second = function (_v0) {
	var y = _v0.b;
	return y;
};
var $author$project$Internal$Money$group = function (list) {
	return A2(
		$elm$core$List$map,
		function (item) {
			return A2($elm$core$List$cons, item.a, item.b);
		},
		A2($elm_community$list_extra$List$Extra$groupWhile, $author$project$Internal$Money$samePeriod, list));
};
...
var $author$project$Internal$Account$simplify = F2(
	function (bt, account) {
		var acct = account.a;
		var _v0 = A2($author$project$Internal$Account$ensureValid, bt, account);
		var acct2 = _v0.a;
		var groups = $author$project$Internal$Money$group(acct2.transactions);
		var transactions_ = $elm_community$maybe_extra$Maybe$Extra$values(
			A2($elm$core$List$map, $author$project$Internal$Money$consolidate, groups));
		return $author$project$Internal$Account$Account(
			{currency: acct.currency, transactions: transactions_});
	});
var $author$project$Internal$Account$credit = F3(
	function (bt, m, _v0) {
		var acct = _v0.a;
		return A2(
			$author$project$Internal$Account$simplify,
			bt,
			$author$project$Internal$Account$Account(
				_Utils_update(
					acct,
					{
						transactions: A2($elm$core$List$cons, m, acct.transactions)
					})));
	});
var $author$project$Account$credit = $author$project$Internal$Account$credit;
var $author$project$EngineData$initialHousehold = function (config) {
	return A2(
		$author$project$Entity$Entity,
		{
			color: A4($avh4$elm_color$Color$rgba, 0.8, 0.6, 0.0, 0.8),
			complementaryAccount: $author$project$Account$empty($author$project$EngineData$cambiatus),
			entityType: $author$project$Entity$THousehold,
			fiatAccount: A3(
				$author$project$Account$credit,
				$author$project$Money$bankTime(0),
				A3($author$project$Money$createInfinite, $author$project$EngineData$fiatCurrency, 0, 4),
				$author$project$Account$empty($author$project$EngineData$fiatCurrency)),
			inventory: _List_fromArray(
				[
					A2($author$project$ModelTypes$setQuantity, 4, config.itemA)
				]),
			name: '1',
			position: A2($jxxcarlson$elm_cell_grid$CellGrid$Position, 20, 15)
		},
		$author$project$Entity$HouseholdCharacteristics(
			{monthlyConsumptionA: 0}));
};
...
var $author$project$EngineData$initialHouseHoldGeneratorState = F3(
	function (config, k, maxHouseHolds) {
		var existingPositions = A2(
			$elm$core$List$cons,
			$author$project$Entity$getPosition(
				$author$project$EngineData$initialHousehold(config)),
			A2(
				$elm$core$List$map,
				$author$project$Entity$getPosition,
				$author$project$EngineData$businesses(config)));
		var _v0 = A2(
			$elm$random$Random$step,
			A2($elm$random$Random$int, 0, config.gridWidth),
			$elm$random$Random$initialSeed(k));
		var i = _v0.a;
		var seed1 = _v0.b;
		var _v1 = A2(
			$elm$random$Random$step,
		...
		var j = _v1.a;
		var seed2 = _v1.b;
		return {count: 1, existingPositions: existingPositions, households: _List_Nil, maxHouseHolds: maxHouseHolds, seed: seed2};
	});
var $author$project$EngineData$initialInventory = function (config) {
	return _List_fromArray(
		[
			A2($author$project$ModelTypes$setQuantity, 1, config.itemA)
		]);
};
var $author$project$Entity$setInventory = F2(
	function (inventory_, _v0) {
		var common = _v0.a;
		var characteristics = _v0.b;
		return A2(
			$author$project$Entity$Entity,
...
var $author$project$EngineData$newState = F3(
	function (config, k, s) {
		var newCount = s.count + 1;
		var newName = $elm$core$String$fromInt(newCount);
		var _v0 = A2(
			$elm$random$Random$step,
			A2($elm$random$Random$int, 0, config.gridWidth),
			s.seed);
		...
		var seed2 = _v1.b;
		var newHousehold = A2(
			$author$project$Entity$setInventory,
			$author$project$EngineData$initialInventory(config),
			A2(
				$author$project$Entity$setName,
				newName,
				A3(
		...
		return _Utils_update(
			...
			{
				count: newCount,
				existingPositions: A2(
					$elm$core$List$cons,
					A2($jxxcarlson$elm_cell_grid$CellGrid$Position, i, j),
					s.existingPositions),
				households: A2($elm$core$List$cons, newHousehold, s.households),
				seed: seed2
			});
	});
var $author$project$EngineData$generateHouseholds = F3(
	function (config, intSeed, numberOfHouseholds) {
		var i = A3($author$project$EngineData$initialHouseHoldGeneratorState, config, intSeed, config.numberOfHouseholds);
		var s = A3(
			$elm$core$List$foldl,
			$author$project$EngineData$newState(config),
			i,
			A2($elm$core$List$range, 0, numberOfHouseholds - 1));
		return s.households;
	});
var $author$project$State$configureWithHouseholds = F4(
	function (config, intSeed, numberOfHouseholds, state) {
		return _Utils_update(
			state,
			{
				households: A3($author$project$EngineData$generateHouseholds, config, intSeed, numberOfHouseholds)
			});
	});
var $author$project$Entity$SupplierCharacteristics = function (a) {
	return {$: 'SupplierCharacteristics', a: a};
};
var $author$project$Entity$TSupplier = {$: 'TSupplier'};
var $author$project$EngineData$supplier1 = function (config) {
	return A2(
		$author$project$Entity$Entity,
		{
			color: A4($avh4$elm_color$Color$rgba, 1.0, 0.3, 1.0, 0.8),
			complementaryAccount: $author$project$Account$empty($author$project$EngineData$cambiatus),
			entityType: $author$project$Entity$TSupplier,
			fiatAccount: $author$project$Account$empty($author$project$EngineData$fiatCurrency),
			inventory: _List_Nil,
			name: 'S1',
			position: A2($jxxcarlson$elm_cell_grid$CellGrid$Position, 1, 1)
		},
		$author$project$Entity$SupplierCharacteristics(
			{}));
};
var $author$project$EngineData$suppliers = function (config) {
	return _List_fromArray(
		[
			$author$project$EngineData$supplier1(config)
		]);
};
var $author$project$State$configureWithSuppliers = F2(
	function (config, state) {
		return _Utils_update(
			state,
			{
				suppliers: $author$project$EngineData$suppliers(config)
			});
	});
var $author$project$State$initialState = {
	...
	data: _List_Nil,
	educators: _List_Nil,
	households: _List_Nil,
	log: _List_Nil,
	randInt: 4321,
	seed: $elm$random$Random$initialSeed(1234),
	suppliers: _List_Nil,
	tick: 0,
...
var $author$project$Main$randomNumberUrl = function (maxDigits) {
	var suffix = '&col=1&base=10&format=plain&rnd=new';
	var prefix = 'https://www.random.org/integers/?num=1&min=1&max=';
	var maxNumber = A2($elm$core$Basics$pow, 10, maxDigits);
	return _Utils_ap(
		prefix,
		_Utils_ap(
			$elm$core$String$fromInt(maxNumber),
			suffix));
};
...
var $author$project$Main$subscriptions = function (model) {
	return A2($elm$time$Time$every, model.state.config.tickLoopInterval, $author$project$Main$Tick);
};
var $author$project$Main$Batch = {$: 'Batch'};
var $author$project$Main$BatchDone = {$: 'BatchDone'};
...
var $author$project$Main$updateTrialsToRun = F2(
	function (str, model) {
		var _v0 = $elm$core$String$toInt(str);
		if (_v0.$ === 'Nothing') {
			return _Utils_update(
				model,
				{trialsToRunString: str});
		} else {
			var k = _v0.a;
			return _Utils_update(
				model,
				{
					trialsToRun: A2($elm$core$Debug$log, 'TrialsToRun', k),
					trialsToRunString: str
				});
		}
	});
var $author$project$Main$updateParameters = function (model) {
	return A2(
		$author$project$Main$updateTrialsToRun,
	...
	function (f, _v0, _v1) {
		...
		return $author$project$ModelTypes$Item(
			_Utils_update(
				data1,
				{
					quantity: A2(f, data1.quantity, data2.quantity)
				}));
	});
var $author$project$Internal$Inventory$name = function (_v0) {
	var data = _v0.a;
	return data.name;
};
var $author$project$Internal$Inventory$price = function (_v0) {
	var data = _v0.a;
	return data.price;
};
var $author$project$Internal$Inventory$addToItem = F2(
	function (source, target) {
		var _v0 = _Utils_Tuple2(
			_Utils_eq(
				$author$project$Internal$Inventory$name(source),
				$author$project$Internal$Inventory$name(target)),
			_Utils_eq(
				$author$project$Internal$Inventory$price(source),
				$author$project$Internal$Inventory$price(target)));
		if (_v0.a && _v0.b) {
			return A3($author$project$Internal$Inventory$map2Item, $elm$core$Basics$add, source, target);
		} else {
			return target;
		}
	});
var $author$project$Inventory$price = $author$project$Internal$Inventory$price;
var $author$project$Inventory$add = F2(
	function (item, inventory) {
		var _v0 = $elm$core$List$head(
			A2(
				...
				function (i) {
					return _Utils_eq(
						$author$project$Internal$Inventory$name(i),
						$author$project$Internal$Inventory$name(item)) && _Utils_eq(
						$author$project$Inventory$price(i),
						$author$project$Inventory$price(item));
				},
				inventory));
		if (_v0.$ === 'Nothing') {
			return A2($elm$core$List$cons, item, inventory);
		} else {
			var target = _v0.a;
			return A2(
				$elm$core$List$map,
				function (targetItem) {
					return A2($author$project$Internal$Inventory$addToItem, item, targetItem);
				},
				inventory);
		}
	});
var $author$project$Entity$mapInventory = F2(
	function (f, _v0) {
		var common = _v0.a;
		var characterstics = _v0.b;
		return A2(
			$author$project$Entity$Entity,
			_Utils_update(
				common,
				{
					inventory: f(common.inventory)
				}),
			characterstics);
	});
var $author$project$Entity$addToInventory = F2(
	function (item, e) {
		return A2(
			$author$project$Entity$mapInventory,
			function (inv) {
				return A2($author$project$Inventory$add, item, inv);
			},
			e);
	});
var $author$project$Internal$Money$createFinite = F4(
	function (currency_, issuedAt_, expiresAt_, amount_) {
		return $author$project$Internal$Types$Money(
			{
				amount: $author$project$Internal$Types$Cents(
					$elm$core$Basics$round(100.0 * amount_)),
				currency: currency_,
				expiresAt: $author$project$Internal$Types$Finite(
					$author$project$Internal$Types$BankTime(expiresAt_)),
				issuedAt: $author$project$Internal$Types$BankTime(issuedAt_)
			});
	});
var $author$project$Money$createFinite = $author$project$Internal$Money$createFinite;
var $author$project$Internal$Money$getBankTime = function (_v0) {
	var t = _v0.a;
	return t;
};
var $author$project$Money$getBankTime = $author$project$Internal$Money$getBankTime;
var $author$project$Entity$getCCAccount = function (_v0) {
	var common = _v0.a;
	return common.complementaryAccount;
};
var $author$project$Entity$getFiatAccount = function (_v0) {
	var common = _v0.a;
	return common.fiatAccount;
};
var $author$project$Entity$setCCAccount = F2(
	function (account, _v0) {
		var common = _v0.a;
		var _char = _v0.b;
		return A2(
			$author$project$Entity$Entity,
...
var $author$project$Entity$setFiatAccount = F2(
	function (account, _v0) {
		var common = _v0.a;
		var _char = _v0.b;
		return A2(
...
var $author$project$Internal$Money$ctype = function (_v0) {
	var t = _v0.a;
	return t;
};
var $author$project$Money$typeOfCurrency = function (currency_) {
	return $author$project$Internal$Money$ctype(currency_);
};
var $author$project$ActionHelper$creditEntity = F6(
	function (config, t, currency, expiration, amount, entity) {
		var money = function () {
			var _v2 = _Utils_Tuple2(
				$author$project$Money$typeOfCurrency(currency),
				expiration);
			if (_v2.a.$ === 'Fiat') {
				var _v3 = _v2.a;
				return A3($author$project$Money$createInfinite, currency, 0, amount);
			} else {
				if (_v2.b.$ === 'Infinite') {
					var _v4 = _v2.a;
					var _v5 = _v2.b;
					...
					var s = _v2.b.a;
					return A4(
						$author$project$Money$createFinite,
						currency,
						t,
						$author$project$Money$getBankTime(s),
						amount);
				}
			}
		}();
		var account = function () {
			var _v1 = $author$project$Money$typeOfCurrency(currency);
			if (_v1.$ === 'Fiat') {
				return A3(
					$author$project$Account$credit,
				...
				return A3(
					...
					$author$project$Money$bankTime(t),
					money,
					$author$project$Entity$getCCAccount(entity));
			}
		}();
		var _v0 = $author$project$Money$typeOfCurrency(currency);
		if (_v0.$ === 'Fiat') {
			return A2($author$project$Entity$setFiatAccount, account, entity);
		} else {
			return A2($author$project$Entity$setCCAccount, account, entity);
		}
	});
var $author$project$Value$intValueOfCents = function (_v0) {
	var k = _v0.a;
	return k;
};
var $author$project$Value$intValue = function (_v0) {
	var currency = _v0.a;
	var cents = _v0.b;
	return $author$project$Value$intValueOfCents(cents);
};
var $author$project$Value$toFloat_ = function (value) {
	return function (x) {
		return x / 100;
	}(
		$author$project$Value$intValue(value));
};
var $author$project$Internal$Account$valueInCents_ = function (list) {
	if (!list.b) {
		return $author$project$Internal$Types$Cents(0);
	} else {
		return function (s) {
...
var $author$project$Internal$Account$valueInCents = function (_v0) {
	var acct = _v0.a;
	return $author$project$Internal$Account$valueInCents_(acct.transactions);
};
var $author$project$Internal$Account$value = F2(
	function (bankTime_, account) {
		var acct = account.a;
		return function (v) {
			return A2($author$project$Internal$Types$Value, acct.currency, v);
		}(
			$author$project$Internal$Account$valueInCents(
				A2($author$project$Internal$Account$ensureValid, bankTime_, account)));
	});
var $author$project$Account$value = $author$project$Internal$Account$value;
var $author$project$Entity$getCCAccountFloatValue = F2(
	function (t, _v0) {
		var common = _v0.a;
		return $author$project$Value$toFloat_(
			A2(
				$author$project$Account$value,
				$author$project$Money$bankTime(t),
				common.complementaryAccount));
	});
var $author$project$Entity$getFiatAccountFloatValue = F2(
	function (t, _v0) {
		var common = _v0.a;
		return $author$project$Value$toFloat_(
			A2(
...
var $author$project$Report$fiatBalanceOfEntity = F2(
	function (bt, entity) {
		return $author$project$Value$toFloat_(
			A2(
				$author$project$Account$value,
	...
	function (purchaseAmt_, business_, newBusiness_) {
		var oldFiatBalance = $elm$core$String$fromFloat(
			A2(
				...
				$author$project$Money$bankTime(0),
				business_));
		var newFiatBalance = $elm$core$String$fromFloat(
			A2(
				$author$project$Report$fiatBalanceOfEntity,
				$author$project$Money$bankTime(0),
				newBusiness_));
		return 'Biz ' + ($author$project$Entity$getName(newBusiness_) + (' buy ' + ($elm$core$String$fromInt(purchaseAmt_) + (', bal: ' + (oldFiatBalance + (' >> ' + newFiatBalance))))));
	});
...
var $author$project$Action$logItem = F2(
	function (state, item) {
		return A2(
			$elm$core$List$cons,
			A3(
				...
				3,
				_Utils_chr(' '),
				$elm$core$String$fromInt(state.tick)) + (': ' + item),
			state.log);
	});
...
var $author$project$Action$randomPurchaseAmount = F2(
	function (state, seed) {
		var randomPurchaseAmount_ = function (q) {
...
var $author$project$Action$buy_3 = F3(
	function (state, seed, business) {
		...
		var newBusinesses = A3(
			...
			function (b) {
				return _Utils_eq(
					$author$project$Entity$getName(b),
					$author$project$Entity$getName(newBusiness));
			},
			function (b) {
				return newBusiness;
			},
...
var $author$project$Entity$inventory = function (_v0) {
	var common = _v0.a;
	return common.inventory;
};
var $author$project$ModelTypes$itemName = function (_v0) {
	var i = _v0.a;
	return i.name;
};
var $author$project$ModelTypes$itemQuantity = function (_v0) {
	var i = _v0.a;
	return i.quantity;
};
var $author$project$Entity$inventoryAmount = F2(
	function (itemName_, e) {
		return $elm$core$List$sum(
			A2(
				$elm$core$List$map,
				$author$project$ModelTypes$itemQuantity,
				A2(
					$elm$core$List$filter,
					function (i) {
						return _Utils_eq(
							$author$project$ModelTypes$itemName(i),
							itemName_);
					},
					$author$project$Entity$inventory(e))));
	});
...
var $author$project$Action$businessPurchaseCeiling = function (state) {
	return $elm$core$Basics$round((state.config.monthlyPurchaseCeilingInUnits * state.tick) / 30.0) + state.config.monthlyPurchaseCeilingHeadRoom;
};
...
var $author$project$Utility$indexOfX = F2(
	function (p, n) {
		return A3(
			$elm$core$Basics$clamp,
			0,
			n - 1,
			$elm$core$Basics$floor(p * n));
	});
var $author$project$Utility$elementAtX = F2(
	function (x, list) {
		return ((x < 0) || (x > 1)) ? $elm$core$Maybe$Nothing : A2(
			$elm_community$list_extra$List$Extra$getAt,
			A2(
				$author$project$Utility$indexOfX,
				x,
				$elm$core$List$length(list)),
			list);
	});
var $author$project$Utility$probability = A2($elm$random$Random$float, 0, 1);
var $author$project$Utility$randomElement = F2(
	function (seed, list) {
		var _v0 = A2($elm$random$Random$step, $author$project$Utility$probability, seed);
		var x = _v0.a;
		var newSeed = _v0.b;
		return _Utils_Tuple2(
			A2($author$project$Utility$elementAtX, x, list),
			newSeed);
	});
var $author$project$Action$selectRandomBusiness = function (state) {
	var _v0 = A2($elm$random$Random$step, $author$project$Action$probability, state.seed);
	var p = _v0.a;
	var newSeed = _v0.b;
	return (_Utils_cmp(p, state.config.probabilityOfPurchasing) > 0) ? _Utils_Tuple2($elm$core$Maybe$Nothing, newSeed) : A2($author$project$Utility$randomElement, newSeed, state.businesses);
};
var $author$project$Entity$unitsPurchased = function (_v0) {
	var characteristics = _v0.b;
	if (characteristics.$ === 'BusinessCharacteristics') {
		var data = characteristics.a;
		return $elm$core$Maybe$Just(data.unitsPurchased);
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Action$randomBusiness = function (state) {
	var fractionalPurchaseCeilingToDate = $author$project$Action$businessPurchaseCeiling(state);
	var _v0 = $author$project$Action$selectRandomBusiness(state);
	var business__ = _v0.a;
	var newSeed = _v0.b;
	var _v1 = A2(
		$elm$core$Maybe$map,
		function (x) {
			return _Utils_cmp(x, fractionalPurchaseCeilingToDate) < 0;
		},
		A2($elm$core$Maybe$andThen, $author$project$Entity$unitsPurchased, business__));
	if ((_v1.$ === 'Just') && _v1.a) {
		return _Utils_Tuple2(business__, newSeed);
	} else {
		return _Utils_Tuple2($elm$core$Maybe$Nothing, newSeed);
	}
};
...
var $author$project$Action$businessPaysRent = F2(
	function (t, state) {
		var debit = A5($author$project$ActionHelper$creditEntity, state.config, state.tick, state.config.fiatCurrency, $author$project$Internal$Types$Infinite, -state.config.businessRent);
		var _v0 = _Utils_eq(
			A2($elm$core$Basics$modBy, 30, t),
			state.config.rentDueDate);
		if (_v0) {
			return _Utils_update(
				state,
				{
					businesses: A2($elm$core$List$map, debit, state.businesses)
				});
		} else {
			return state;
		}
...
var $author$project$ModelTypes$InsufficientQuantity = {$: 'InsufficientQuantity'};
var $author$project$ModelTypes$InventoryOpSuccess = {$: 'InventoryOpSuccess'};
var $author$project$ModelTypes$NoSuchItem = {$: 'NoSuchItem'};
var $author$project$Internal$Inventory$mapItem = F2(
	function (f, _v0) {
		var data = _v0.a;
		return $author$project$ModelTypes$Item(
			_Utils_update(
...
var $author$project$Internal$Inventory$quantity = function (_v0) {
	var data = _v0.a;
	return data.quantity;
};
var $author$project$Inventory$quantity = $author$project$Internal$Inventory$quantity;
var $author$project$Internal$Inventory$subFromItem = F2(
	function (source, target) {
		var _v0 = _Utils_Tuple2(
			_Utils_eq(
				$author$project$Internal$Inventory$name(source),
			...
			_Utils_eq(
				...
				$author$project$Internal$Inventory$price(target)));
		if (_v0.a && _v0.b) {
			return A3($author$project$Internal$Inventory$map2Item, $elm$core$Basics$sub, target, source);
		} else {
			return target;
		}
	});
var $author$project$Inventory$sub = F2(
	function (item, inventory) {
		var _v0 = $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				...
				inventory));
		if (_v0.$ === 'Nothing') {
			return _Utils_Tuple2($author$project$ModelTypes$NoSuchItem, inventory);
		} else {
			var target = _v0.a;
			if (_Utils_cmp(
				$author$project$Inventory$quantity(target),
				$author$project$Inventory$quantity(item)) > -1) {
				return _Utils_Tuple2(
					$author$project$ModelTypes$InventoryOpSuccess,
					A2(
						$elm$core$List$map,
						function (targetItem) {
							return A2($author$project$Internal$Inventory$subFromItem, item, targetItem);
						},
						inventory));
			} else {
				var adjustedItem = A2(
					$author$project$Internal$Inventory$mapItem,
					function (q) {
						return $author$project$Inventory$quantity(target);
					},
					item);
				return _Utils_Tuple2(
					$author$project$ModelTypes$InsufficientQuantity,
					A2(
						$elm$core$List$map,
						function (targetItem) {
							return A2($author$project$Internal$Inventory$subFromItem, adjustedItem, targetItem);
						},
						inventory));
			}
		}
	});
var $author$project$Action$consumeA = F2(
	function (t, state) {
		if (A2(
			$elm$core$List$member,
			A2($elm$core$Basics$modBy, 30, t),
			state.config.householdConsumptionDays)) {
			var reduceInventoryOfA = function (inventory) {
				return A2($author$project$Inventory$sub, state.config.itemA, inventory).b;
			};
			var reduceInventoryOfHouseHold = function (e) {
				return (A2($author$project$Entity$inventoryAmount, 'AA', e) > 0) ? A2($author$project$Entity$mapInventory, reduceInventoryOfA, e) : e;
			};
			var positiveInventoryHouseholds = A2(
				$elm$core$List$filter,
				function (e) {
					return A2($author$project$Entity$inventoryAmount, 'AA', e) > 0;
				},
				state.households);
			var newHouseholds = A2($elm$core$List$map, reduceInventoryOfHouseHold, state.households);
			return _Utils_update(
				state,
				{
					households: newHouseholds,
					totalHouseholdConsumption: state.totalHouseholdConsumption + $elm$core$List$length(positiveInventoryHouseholds)
				});
		} else {
			return state;
		}
...
var $author$project$Action$householdPurchaseAmount = F2(
	function (seed, state) {
		...
		var p = _v0.a;
		var newSeed = _v0.b;
		var amt = state.config.householdMinimumPurchaseAmount + $elm$core$Basics$round(p * range);
		var adjustedAmount = A2($elm$core$Basics$min, amt, state.config.householdInventoryUpperLimit);
		return _Utils_Tuple2(adjustedAmount, newSeed);
	});
var $author$project$Action$amountToPurchaseFromShop = F3(
	function (state, shop__, household__) {
		...
		var purchaseAmt = _v0.a;
		var newSeed_ = _v0.b;
		return (_Utils_cmp(householdInventoryAmt, state.config.householdInventoryUpperLimit) > -1) ? _Utils_Tuple2(0, newSeed_) : ((_Utils_cmp(purchaseAmt, shopInventoryAmt) > 0) ? _Utils_Tuple2(shopInventoryAmt, newSeed_) : _Utils_Tuple2(purchaseAmt, newSeed_));
	});
var $author$project$Internal$Cents$map = F2(
	function (f, _v0) {
		var k = _v0.a;
		return $author$project$Internal$Types$Cents(
			f(k));
	});
var $author$project$Internal$Cents$negate = function (cents) {
	return A2(
		$author$project$Internal$Cents$map,
		function (k) {
			return -k;
		},
		cents);
};
var $author$project$Internal$Money$negate = function (_v0) {
	var m = _v0.a;
	return $author$project$Internal$Types$Money(
		_Utils_update(
			m,
			{
				amount: $author$project$Internal$Cents$negate(m.amount)
			}));
};
var $author$project$Internal$Account$debit = F3(
	function (bt, m, _v0) {
		var acct = _v0.a;
		return A2(
			$author$project$Internal$Account$simplify,
			...
			$author$project$Internal$Account$Account(
				_Utils_update(
					acct,
					{
						transactions: A2(
							$elm$core$List$cons,
							$author$project$Internal$Money$negate(m),
							acct.transactions)
					})));
	});
var $author$project$Account$debit = $author$project$Internal$Account$debit;
var $author$project$Internal$Account$currency = function (_v0) {
	var data = _v0.a;
	return data.currency;
};
var $author$project$Internal$Account$currencyType = function (account) {
	return $author$project$Internal$Money$ctype(
		$author$project$Internal$Account$currency(account));
};
var $author$project$Account$currencyType = $author$project$Internal$Account$currencyType;
var $author$project$Entity$mapAccount = F3(
	function (f, account, e) {
		var _v0 = $author$project$Account$currencyType(account);
		if (_v0.$ === 'Fiat') {
			return A2(
				$author$project$Entity$setFiatAccount,
				f(account),
				e);
		} else {
			return A2(
				$author$project$Entity$setCCAccount,
				f(account),
				e);
		}
	});
var $author$project$Internal$Cents$imap = F3(
	function (f, k, _v0) {
		var c = _v0.a;
		return $author$project$Internal$Types$Cents(
			A2(f, k, c));
	});
var $author$project$Internal$Cents$mul = F2(
	function (k, c) {
		return A3(
			$author$project$Internal$Cents$imap,
			F2(
				function (k_, n_) {
					return k_ * n_;
				}),
...
var $author$project$Internal$Money$mul = F2(
	function (k, _v0) {
		var data = _v0.a;
		return $author$project$Internal$Types$Money(
			_Utils_update(
				data,
				{
					amount: A2($author$project$Internal$Cents$mul, k, data.amount)
				}));
	});
...
var $author$project$Action$incrementLostSales = F2(
...
var $author$project$Action$nextState = function (st) {
	...
	if (_v0.$ === 'Nothing') {
		return $author$project$Action$Done(
			{emptyShops: _List_Nil, log: st.log, targetShop: $elm$core$Maybe$Nothing});
	} else {
		var shop = _v0.a;
		...
		if (_v1) {
			return $author$project$Action$Loop(
				{
					emptyShops: A2($elm$core$List$cons, shop, st.emptyShops),
					log: A2($author$project$Action$incrementLostSales, shop, st.log),
					shops: A2($elm$core$List$drop, 1, st.shops)
				});
		} else {
			return $author$project$Action$Done(
				{
					emptyShops: st.emptyShops,
					log: st.log,
					targetShop: $elm$core$Maybe$Just(shop)
				});
		}
	}
};
...
var $author$project$Action$findShopWithPositiveInventory = F2(
	function (state, household) {
		var businesses = A2(
			...
			function (e) {
				return A2($author$project$Entity$distance, e, household);
			},
			state.businesses);
		return A2(
			$author$project$Action$loop,
			{emptyShops: _List_Nil, log: state.businessLog, shops: businesses},
			$author$project$Action$nextState);
	});
var $author$project$Action$householdBuysGoods_ = F3(
	function (t, household_, state) {
		var data = A2($author$project$Action$findShopWithPositiveInventory, state, household_);
		var message = function () {
			var _v5 = _Utils_Tuple2(
				data.targetShop,
				A2($elm$core$List$map, $author$project$Entity$getName, data.emptyShops));
			_v5$2:
			while (true) {
				if (_v5.a.$ === 'Just') {
					if (!_v5.b.b) {
			...
			var list = _v5.b;
			return 'Empty: ' + A2($elm$core$String$join, ', ', list);
		}();
		var _v0 = data.targetShop;
		if (_v0.$ === 'Nothing') {
			return _Utils_update(
				state,
			...
			var shop = _v0.a;
			var _v1 = A3($author$project$Action$amountToPurchaseFromShop, state, shop, household_);
			var amountToPurchase = _v1.a;
			var newSeed = _v1.b;
			var _v2 = A5($author$project$Action$buyItem, t, state, amountToPurchase, household_, shop);
			var newHousehold = _v2.a;
			var newBusiness = _v2.b;
			var newBusinesses = A3(
				$elm_community$list_extra$List$Extra$updateIf,
				function (e1) {
					return _Utils_eq(
						$author$project$Entity$getName(e1),
						$author$project$Entity$getName(shop));
				},
				function (_v4) {
					return newBusiness;
				},
...
var $author$project$Action$householdBuysGoods = F2(
	function (t, state) {
		var sortByInventory = function (e) {
			return A2($author$project$Entity$inventoryAmount, 'AA', e);
		};
		var n = $elm$core$List$length(state.households);
		var orderedHouseholds = A2(
			$elm$core$List$take,
			(n / 2) | 0,
			A2(
				$elm$core$List$sortBy,
				function (e) {
					return sortByInventory(e);
				},
				state.households));
		var _v0 = A2($author$project$Utility$randomElement, state.seed, orderedHouseholds);
		var needyHousehold = _v0.a;
		var newSeed = _v0.b;
		if (needyHousehold.$ === 'Nothing') {
			return _Utils_update(
				state,
				{seed: newSeed});
		} else {
			var e = needyHousehold.a;
			return A3(
				$author$project$Action$householdBuysGoods_,
				t,
				e,
				_Utils_update(
					state,
...
var $author$project$Utility$iterate = F3(
	function (n, f, x0) {
		iterate:
		while (true) {
			if (!n) {
...
var $author$project$ActionHelper$creditHouseHolds = F3(
	function (config, t, households) {
		...
		var amount = config.periodicHouseHoldFiatIncome;
		return A2(
			$elm$core$List$map,
			A5($author$project$ActionHelper$creditEntity, config, t, currency, $author$project$Internal$Types$Infinite, amount),
			households);
	});
var $author$project$Action$payHouseholds = F3(
	function (config, t, state) {
		if (A2(
			$elm$core$List$member,
			A2($elm$core$Basics$modBy, 30, t),
			state.config.householdPayDays)) {
			var households = A3($author$project$ActionHelper$creditHouseHolds, config, t, state.households);
			return _Utils_update(
				state,
...
var $author$project$Action$readEducationalContent = function (state) {
	var _v0 = state.config.ccEarnings;
	if (_v0.$ === 'CCEarningsOFF') {
		return state;
	} else {
		var _v1 = A2($elm$core$Basics$modBy, state.config.educationalContentCycle, state.tick) === 3;
		if (!_v1) {
			return state;
		} else {
			var config = state.config;
			var exp = config.complementaryCurrencyExpiration;
			var amount = config.educationPaymentPerCycle;
			var earnCC = function (e) {
				return A6($author$project$ActionHelper$creditEntity, config, state.tick, config.complementaryCurrency, exp, amount, e);
			};
			var newBusinesses = A2($elm$core$List$map, earnCC, state.businesses);
			var n = $elm$core$List$length(newBusinesses);
			var amountEarned = n * amount;
			var logString = 'Earn CC for ' + ($elm$core$String$fromInt(n) + (' biz: ' + $elm$core$String$fromFloat(amountEarned)));
			return _Utils_update(
				state,
				{
					businesses: newBusinesses,
...
var $author$project$Report$businessInventoryOf = F2(
	function (itemName_, state) {
		var f = function (e) {
			return $elm$core$List$sum(
				A2(
					$elm$core$List$map,
...
var $author$project$Engine$nextState = F3(
	function (config_, t, state) {
		return A2(
			$author$project$Action$recordData,
			t,
			A2(
				$author$project$Action$consumeA,
				t,
				A2(
					...
					A2(
						...
						A3(
							...
							config_,
							t,
							$author$project$Action$businessBuysGoods(
								$author$project$Action$readEducationalContent(
									_Utils_update(
										state,
										{tick: t}))))))));
	});
...
var $author$project$Main$updateBusinessLog = F4(
	function (model, runMode_, counter_, log) {
		var _v0 = _Utils_Tuple2(runMode_, counter_);
		if ((_v0.a.$ === 'Batch') && (!_v0.b)) {
			var _v1 = _v0.a;
...
var $author$project$Main$updateData = F3(
	function (model, runState, bjs) {
		...
		if (_v0.$ === 'Single') {
			...
			var _v2 = _Utils_Tuple2(runState, bjs);
			_v2$2:
			while (true) {
				if (_v2.a.$ === 'BatchDone') {
					switch (_v2.b.$) {
...
var $author$project$Main$updateRunParameters = function (model) {
	var _v0 = model.runMode;
	if (_v0.$ === 'Single') {
		var _v1 = _Utils_cmp(model.counter, model.state.config.cycleLength) < 0;
		if (_v1) {
		...
		switch (msg.$) {
			...
			case 'Tick':
				...
				if (_v1.$ === 'Running') {
					...
					var _v2 = $author$project$Main$updateRunParameters(model);
					var counter = _v2.a;
					var runState = _v2.b;
					var batchJobState_ = _v2.c;
					var newData = A3($author$project$Main$updateData, model, runState, batchJobState_);
					var newState = A2(
						refreshLog,
						runState,
						A2(
							...
							A3(
								...
								function (st) {
									return _Utils_update(
										st,
										{
											businessLog: A4($author$project$Main$updateBusinessLog, model, model.runMode, counter, st.businessLog)
										});
								}(model.state))));
					var runState2 = function () {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{batchJobState: batchJobState_, counter: counter, data: newData, runState: runState2, state: newState}),
			...
			case 'Reset':
				...
				return _Utils_Tuple2(
					A2(
						$author$project$Main$updateTrialsToRun,
						model.trialsToRunString,
						A2(
							$author$project$Main$updateTickRate,
							model.tickRateString,
							A2(
								$author$project$Main$updateRent,
								model.rentString,
								A2(
									$author$project$Main$updateCycleLength,
									model.cycleLengthString,
									A2(
										$author$project$Main$updateCCRatio,
										model.ccRatioString,
										_Utils_update(
			...
			case 'AcceptFilter':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{filterString: str}),
					$elm$core$Platform$Cmd$none);
			case 'AcceptCycleLength':
				var str = msg.a;
				return $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
					A2($author$project$Main$updateCycleLength, str, model));
			case 'AcceptTickRate':
				var str = msg.a;
				return $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
					A2($author$project$Main$updateTickRate, str, model));
			case 'AcceptCCRatio':
				var str = msg.a;
				return $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
					A2($author$project$Main$updateCCRatio, str, model));
			case 'AcceptRentString':
				var str = msg.a;
				return $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
					A2($author$project$Main$updateRent, str, model));
			case 'AcceptTrialsString':
				var str = msg.a;
				return $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
							...
							_Utils_update(
								model,
								{
									...
									state: function (state) {
										...
										A2($author$project$State$configure, config, rn))
								}));
					}
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Main$AcceptCycleLength = function (a) {
...
var $author$project$Main$AcceptTrialsString = function (a) {
	return {$: 'AcceptTrialsString', a: a};
};
var $author$project$Main$trialsToRunInput = function (model) {
	return A3($author$project$Main$dashboardInput, $author$project$Main$AcceptTrialsString, model.trialsToRunString, 'Trials');
};
var $author$project$Main$controlPanel = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		$author$project$Style$controlPanel,
		_List_fromArray(
			[
				A2(
				$mdgriffith$elm_ui$Element$el,
				...
				$author$project$Main$trialsToRunInput(model),
				$author$project$Main$tickRateInput(model),
				$author$project$Main$ccRatioInput(model),
				$author$project$Main$rentInput(model)
			]));
};
var $author$project$Main$businessInventory = function (model) {
	return A2(
		$elm$core$String$join,
		', ',
		A2(
			...
			A2($author$project$Report$businessInventoryOf, 'AA', model.state)));
};
var $author$project$Report$ccBalanceOfEntityList = F2(
		...
		var f = function (e) {
			return $author$project$Value$toFloat_(
				A2(
					$author$project$Account$value,
					bt,
					$author$project$Entity$getCCAccount(e)));
		};
		return A2($elm$core$List$map, f, entityList);
	});
var $author$project$Main$ccBalances = function (model) {
	return A2(
		$elm$core$String$join,
		', ',
		A2(
			...
			A2(
				$author$project$Report$ccBalanceOfEntityList,
				$author$project$Money$bankTime(model.state.tick),
				model.state.businesses)));
};
...
var $author$project$Main$clock = function (k) {
	var month = A3(
...
var $author$project$Style$dashboard = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Background$color(
		A3($mdgriffith$elm_ui$Element$rgb255, 200, 200, 200)),
		A2($mdgriffith$elm_ui$Element$paddingXY, 12, 18),
...
var $author$project$Main$displayLostSaleData = function (model) {
	return A2(
		$elm$core$String$join,
		', ',
		A2(
...
var $author$project$Main$fiatBalances = function (model) {
	return A2(
		$elm$core$String$join,
		', ',
		A2(
			...
			$elm$core$String$fromFloat,
			A2(
				$author$project$Report$fiatBalanceOfEntityList,
				$author$project$Money$bankTime(model.state.tick),
				model.state.businesses)));
};
var $author$project$Internal$Account$transactions = function (_v0) {
	var data = _v0.a;
	return data.transactions;
};
var $author$project$Internal$Account$merge = function (list) {
	var _v0 = A2(
		$elm$core$Maybe$map,
		$author$project$Internal$Account$currency,
	...
	if (_v0.$ === 'Just') {
		...
		return $elm$core$Maybe$Just(
			$author$project$Internal$Account$Account(
				{
					currency: currency_,
					transactions: $elm$core$List$concat(
						A2($elm$core$List$map, $author$project$Internal$Account$transactions, list))
				}));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Account$merge = $author$project$Internal$Account$merge;
var $author$project$Entity$fiatHoldingsOEntities = F2(
	function (t, list) {
		var mergedAccounts = $author$project$Account$merge(
			A2($elm$core$List$map, $author$project$Entity$getFiatAccount, list));
		if (mergedAccounts.$ === 'Just') {
			var accounts = mergedAccounts.a;
			return $elm$core$Maybe$Just(
				A2(
					$author$project$Account$value,
					$author$project$Money$bankTime(t),
...
var $author$project$Internal$Money$floatFromCents = function (_v0) {
	var k = _v0.a;
	return k / 100.0;
};
var $author$project$Internal$Money$stringFromCents = function (cents) {
	return $elm$core$String$fromFloat(
		$author$project$Internal$Money$floatFromCents(cents));
};
var $author$project$Internal$Money$stringFromCurrency = function (_v0) {
	var ctype_ = _v0.a;
	var name = _v0.b;
	if (ctype_.$ === 'Fiat') {
		return A2(
...
var $author$project$Internal$Money$valueToString = function (_v0) {
	var currency_ = _v0.a;
	var cents = _v0.b;
	return A2(
		$lukewestby$elm_string_interpolate$String$Interpolate$interpolate,
		...
		_List_fromArray(
			[
				$author$project$Internal$Money$stringFromCurrency(currency_),
				$author$project$Internal$Money$stringFromCents(cents)
			]));
};
var $author$project$Money$valueToString = $author$project$Internal$Money$valueToString;
var $author$project$Main$fiatHoldingsDisplay = function (model) {
	var _v0 = A2($author$project$Entity$fiatHoldingsOEntities, model.counter, model.state.households);
	if (_v0.$ === 'Just') {
		var value = _v0.a;
		return $author$project$Money$valueToString(value);
	} else {
		return '--';
	}
};
var $author$project$Report$householdInventoryOf = F2(
	function (itemName_, state) {
		var f = function (e) {
			return $elm$core$List$sum(
				A2(
		...
		return $elm$core$List$sum(
			A2($elm$core$List$map, f, state.households));
	});
var $author$project$Report$minMaxHouseholdInventoryOf = F2(
	function (itemName_, state) {
		var f = function (e) {
			return $elm$core$List$sum(
				A2(
		...
		var inventories = A2($elm$core$List$map, f, state.households);
		return $elm_community$maybe_extra$Maybe$Extra$values(
			_List_fromArray(
				[
					$elm$core$List$minimum(inventories),
					$elm$core$List$maximum(inventories)
				]));
	});
var $author$project$Main$totalLostSales = function (model) {
	var data = model.state.businessLog;
...
var $author$project$Main$dashboard = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		$author$project$Style$dashboard,
		_List_fromArray(
			[
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(model.state.config.title)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(model.state.config.subtitle)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('------------------------------')),
				...
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'Cycle length = ' + $elm$core$String$fromInt(model.state.config.cycleLength))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'Rate = ' + $elm$core$String$fromFloat(model.state.config.tickLoopInterval))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					$author$project$Main$clock(model.counter))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('------------------------------')),
				...
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'Households = ' + $elm$core$String$fromInt(
						$elm$core$List$length(model.state.households)))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'Household acct bal = ' + $author$project$Main$fiatHoldingsDisplay(model))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'Household inventory = ' + $elm$core$String$fromInt(
						A2($author$project$Report$householdInventoryOf, 'AA', model.state)))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'[min, max] = ' + A2(
						...
						A2(
							$elm$core$List$map,
							$elm$core$String$fromInt,
							A2($author$project$Report$minMaxHouseholdInventoryOf, 'AA', model.state))))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'Total purchases = ' + $elm$core$String$fromInt(model.state.totalHouseholdPurchases))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'Total consumed = ' + $elm$core$String$fromInt(model.state.totalHouseholdConsumption))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'Net purchases = ' + $elm$core$String$fromInt(model.state.totalHouseholdPurchases - model.state.totalHouseholdConsumption))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('------------------------------')),
				...
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'Business inventories = ' + $author$project$Main$businessInventory(model))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'Fiat balances = ' + $author$project$Main$fiatBalances(model))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
				...
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					'CC Ratio = ' + $elm$core$String$fromFloat(model.state.config.maximumCCRatio))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('------------------------------')),
				...
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(
					$author$project$Main$displayLostSaleData(model)))
			]));
};
...
var $author$project$CellGrid$Canvas$asSvg = F3(
	function (_v0, style, list) {
		...
		var br = A3(
			...
			width,
			height,
			A4($avh4$elm_color$Color$rgba, g, g, g + 0.05, 1.0));
		return A2(
			$elm$svg$Svg$g,
			_List_Nil,
...
var $author$project$Engine$entityRadius = function (e) {
	...
	switch (_v0.$) {
		case 'THousehold':
			return 1.5 * (1 + A2($author$project$Entity$inventoryAmount, 'AA', e));
		case 'TShop':
			return 6 + (0.5 * (1 + A2($author$project$Entity$inventoryAmount, 'AA', e)));
		case 'TSupplier':
			return 15;
		default:
			return 15;
...
var $author$project$Entity$getColor = function (_v0) {
	var common = _v0.a;
	var characteristics = _v0.b;
	return common.color;
};
var $author$project$Engine$cellStyle = function (config_) {
	return {
		cellHeight: config_.renderWidth / config_.gridWidth,
		cellWidth: config_.renderWidth / config_.gridWidth,
		toColor: function (e) {
			return $author$project$Entity$getColor(e);
		},
		toPosition: function (e) {
			return $author$project$Entity$getPosition(e);
		},
		toRadius: $author$project$Engine$entityRadius
	};
};
var $author$project$Engine$render = F2(
	function (config_, s) {
		return A3(
			$author$project$CellGrid$Canvas$asHtml,
			{
				height: $elm$core$Basics$round(config_.renderWidth),
				width: $elm$core$Basics$round(config_.renderWidth)
			},
			$author$project$Engine$cellStyle(config_),
			_Utils_ap(
				s.households,
				_Utils_ap(
					s.businesses,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$centerX,
				$mdgriffith$elm_ui$Element$Background$color($author$project$Style$lightColor),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$height(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text(
					$author$project$Main$clock(model.counter))),
				$author$project$Main$filterInput(model),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
...
var $author$project$Style$lightBlue = A3($mdgriffith$elm_ui$Element$rgb255, 90, 90, 255);
...
var $author$project$Main$bgColor = function (model) {
	...
	switch (_v0.$) {
		...
		default:
			return $mdgriffith$elm_ui$Element$Background$color($author$project$Style$lightBlue);
	}
};
...
var $author$project$Style$titleColor = A3($mdgriffith$elm_ui$Element$rgb255, 190, 190, 255);
...
var $author$project$Main$mainColumn = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$title('Simulator II'),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
